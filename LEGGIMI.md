# CASSA DALILA — Guida all'installazione

> **Personalizzazione**: per cambiare il nome dell'app modifica la costante `APP_NAME` in `frontend-src/src/App.jsx` e ricompila con `BUILD_FRONTEND.bat`.
